...
```{r f6, fig.height=6., fig.width=8., fig.cap="Different methods of determining similarity between clusters", fig.alt="This figure shows six ovals arranged in three rows and two columns with individual rows labelled 'Simple Linkage', 'Complete Linkage', and 'Average Linkage' respectfully. Each oval contains three black dots with the first and second row connecting a single dot from each oval with a solid black line and the third row connecting all dots in each oval with many black lines."}
library(plotrix)
...
```{r pacfirst, echo=TRUE, fig.cap="PCA plot for the iris data", fig.alt="This figure shows a scatterplot with x-axis labelled 'PC1 (73%)' and y-axis labelled 'PC2 (23%)' with a legend showing three symbols, 'setosa', 'versicolor' and 'virginica', denoted by a red circle, a green circle and a blue circle, respectively. From left to right on the x-axis, the plot shows a cluster of 'setosa' points, 'versicolor' points, to 'virginica' points."}
...
```{r pactwo, echo=TRUE, fig.cap="PCA biplot for the iris data", fig.alt="This figure shows a plot with x-axis labelled 'PC1 (73%)' and y-axis labelled 'PC2 (23%)' with a legend categorized as 'setosa', 'versicolor' and 'virginica'. 4 purple arrowed lines emerge from the center and one purple line points bottom left labelled 'Sepal.Width', one points bottom right labelled 'Sepal.Length', one points higher than the previous labelled 'Petal.Length', and one point directly right labelled 'Petal.Width and from left to right on the x-axis it shows a centered cluster of 'setosa', 'versicolor' to 'virginica'."}
